...
public enum TypographyStyle {
  case largeTitle(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case title(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case title2(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case title3(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case headline(weight: Font.Weight = .bold, color: Color = CustomColor.onBackground)
  case body(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case callout(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case subheadline(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case footnote(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case caption(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
  case caption2(weight: Font.Weight = .regular, color: Color = CustomColor.onBackground)
